...
(cd $DIR/src/github.com/jjacquay712/GoRods/lib; rm build/libgorods.a; rm build/gorods.o; gcc -ggdb -o build/gorods.o -c wrapper.c -I/usr/include/irods -Iinclude; ar rcs build/libgorods.a build/gorods.o)
