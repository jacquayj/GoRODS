...
# Overwrite local source files, incase there are updates
COPY . /go/src/github.com/jjacquay712/GoRODS

# TODO: 
# Install iRODS server with default user/pass


#Modify tests to use default... autogen credentails needed?
#ENTRYPOINT to run tests
# iquest --sql support IQuestSQL(sqlId string, params []string) 
...
#CMD ["/usr/local/go/bin/go", "test", "-v", "github.com/jjacquay712/GoRODS"]